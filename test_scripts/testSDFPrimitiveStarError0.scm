(set-scene-name "test-primitive-star-error0")

(let* ((material-ground (MaterialDiffuse. (Color3i. "3D5A80") 0))
       (material-star (MaterialDiffuse. (Color3i. "98C1D9") 0)))
  ...
  (set-scene-sdf (SDFBoolUnion. scene-sdf (SDFPrimitiveStarError0. (Vector3d. 0.0 0.0 10.0)
                                                                   20.0
                                                                   material-star))))
