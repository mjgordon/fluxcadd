...
public class PVector implements Serializable {
  ...
  /**
   * New constructor, essentially the inverse of the toString() method (it's meant to handle that format as input)
   * @param s The string defining the x,y,z, coordinates, surrounded by brackets
   */
  public PVector(String s) {
