...
** v00003 - Panel Manager Conversion to Tiling Window System [4/9]
...
- [ ] F : Renderer : Soft shadows
- [X] B : Renderer : Possibility for StackOverflow with reflective materials
- [ ] B : Renderer : Rendering of camera box in preview
- [ ] B : Renderer : Off-hue fireflies 
- [ ] B : Renderer : Phantom shadow on far side of light source
