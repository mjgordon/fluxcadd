...
** v00001 - Basic SDF Rendering System [9/12]
...
- [ ] F : Renderer : Automatically calculate offset heuristic for op fillet size
...
- [ ] F : Renderer : Fillet op optimization to return piecewise linear heuristic until sufficiently close
