...
- [ ] C : UI       : Panel projection matrix doesn't need to be remade every frame
- [ ] C : UI       : Simplify when matrices are sent to shader uniforms in general (and see what amount of mvp premultiplication to do)
- [ ] C : UI       : Remove stateful color from Graphics2D
