...
** v00002 - SDF Rendering Preview System [16/16]
...
- [ ] B : Renderer : Possibility for StackOverflow with reflective materials



** vFuture
- [ ] F : Renderer : Preview Mode, show primitives as material simple color rather than boolean state
- [ ] F : Renderer : Flat background colors
- [ ] F : Renderer : Perlin noise Op
