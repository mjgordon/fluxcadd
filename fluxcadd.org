...
** v00003 - Panel Manager Conversion to Tiling Window System [11/11]
...
- [ ] F : Renderer : Button to set the viewport fov to fit the render box
- [ ] F : Renderer : Slider etc to change viewport fov
- [ ] C : Renderer : Initially scale renderPreview to fit smaller dimension
- [ ] C : Project  : Switch out the Controllable interface for the broader Event system
