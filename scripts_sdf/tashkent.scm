(let* ((material-ground (Material. (Color. "9999AA") 0.0))
  ...
  (let* ((block (SDFBoolIntersection.(SDFPrimitiveCube. (Vector3d. 0.0 0.0 0.0) 4.0 40.0 40.0 material-building)
				     (SDFBoolDifference. (SDFOpSubtract. (SDFPrimitiveCube. (Vector3d. 0.0 0.0 0.0)
											    10.0
											    material-building)
									 1.0)
	 ...
	 (block-slice (SDFBoolIntersection. (SDFPrimitiveCube. (Vector3d. 0.0 0.0 50.0)
									       4.0
									       100.0
									       100.0
									       material-building)
